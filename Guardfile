...
guard 'rspec', zeus: true, parallel: true, bundler: false,  cli: "--profile --color -r rspec/instafail -f RSpec::Instafail", all_after_pass: false, all_on_start: false, keep_failed: false, notification: false do
