RAILS_ROOT = "/Users/yannis/railsapps/biology14_production/current"

God.watch do |w|
  pid_file = File.join(RAILS_ROOT, "tmp/pids/biology14_production_unicorn.pid")

  w.name = "biology14_production_unicorn"
